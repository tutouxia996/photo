...
import com.sq.common.annotation.DataScope;
...
import com.sq.common.utils.bean.BeanValidators;
import com.sq.common.utils.spring.SpringUtils;
import com.sq.system.domain.SysPost;
import com.sq.system.domain.SysUserPost;
import com.sq.system.domain.SysUserRole;
import com.sq.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public int insertUser(SysUser user) {
        user.setId(GeneratorUtil.getNextId());
    ...
    public int deleteUserByIds(Long[] userIds) {
        ...
        int rows = 0;
        for (Long userId : userIds) {
            rows += userMapper.deleteById(userId);
        }
        return rows;
    }
