...
import com.sq.manager.service.SysPasswordService;
...
import com.sq.system.service.ISysRoleService;
...
public class SysUserController extends BaseController {
    ...
    public TableDataInfo list(SysUser user) {
        ...
        fillLoginLockStatus(list);
        return getDataTable(list);
    }

    private void fillLoginLockStatus(List<SysUser> list) {
        for (SysUser user : list) {
            user.setPwdErrorCount(passwordService.getRetryCount(user.getUserName()));
            user.setLocked(passwordService.isLocked(user.getUserName()));
        }
    }
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasAnyPermi('system:user:query,system:user:view')")
