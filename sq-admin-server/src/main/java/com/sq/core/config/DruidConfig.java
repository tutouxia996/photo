...
import com.sq.core.config.properties.DruidProperties;
import com.sq.common.enums.DataSourceType;
import com.sq.common.utils.spring.SpringUtils;
import com.sq.framework.datasource.DynamicDataSource;
...
public class DruidConfig {
    ...
    public DataSource sqlServerDataSource(DruidProperties druidProperties) {
        ...
        // SQL Server 不支持 SELECT NOW()，覆盖全局 validationQuery
    ...
    public DynamicDataSource dataSource(DataSource masterDataSource) {
        ...
        setDataSource(targetDataSources, "SQLSERVER", "sqlServerDataSource");
