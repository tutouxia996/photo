package com.sq.manager.handle;

import com.alibaba.fastjson2.JSON;
import com.sq.common.annotation.Log;
import com.sq.common.core.domain.model.LoginUser;
import com.sq.common.enums.BusinessStatus;
import com.sq.common.enums.HttpMethod;
import com.sq.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Log controllerLog) throws Throwable {
        ...
        Object result = null;
        try {
            result = joinPoint.proceed(); // 继续执行目标方法
        } catch (Throwable e) {
            // 如果有异常发生，记录异常信息
            ...
            // 设置请求方式
            operLog.setRequestMethod(HttpMethod.valueOf(request.getMethod()).name());
            // 处理设置注解上的参数
